...
new _RevealOnScroll2.default(".feature-item", "80%");
...
var RevealOnScroll = function () {
  function RevealOnScroll(element, offset) {
    ...
    this.itemsToReveal = (0, _jquery2.default)(element);
    this.hideInitially();
  ...
  _createClass(RevealOnScroll, [{
    ...
    key: "createWaypoints",
    value: function createWaypoints(callback) {
...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint(waypoint) {
      var self = this;
      new Waypoint({
        element: waypoint,
        handler: function handler() {
    ...
    value: function createPageSectionWaypoints() {
      var headerLinks = this.headerLinks;
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction == "down") {
              ...
              (0, _jquery2.default)(matchingHeaderLink).toggleClass("current-section");
            }
          },
          offset: "20%"
        });
  ...
  _createClass(Modal, [{
    ...
    value: function closeModal() {
      ...
      this.closeModalButton.click(function () {
        return _this2.modal.removeClass("modal--is-visible");
      });
    }
  }, {
    key: "escKey",
    value: function escKey() {
      var _this3 = this;

      (0, _jquery2.default)(document).keyup(function (e) {
        if (e.keyCode == 27) {
          _this3.modal.removeClass("modal--is-visible");
        }
      });
    }
  }]);
